...
(function () {
  ...
  var loadPackage = function (metadata) {
    ...
    var REMOTE_PACKAGE_BASE = "assets/sowa.data";
    if (
  ...
  loadPackage({
    files: [
      ...
      { filename: "/README.md", start: 0, end: 3033 },
      { filename: "/decoder.onnx", start: 3033, end: 7512778 },
      { filename: "/encoder.onnx", start: 7512778, end: 29134462 },
      { filename: "/joiner.onnx", start: 29134462, end: 30930024 },
      { filename: "/tokens.txt", start: 30930024, end: 30978721 },
    ],
    remote_package_size: 30978721,
  });
})();
...
var _malloc = (Module["_malloc"] = (a0) =>
  (_malloc = Module["_malloc"] = wasmExports["ea"])(a0));
var _free = (Module["_free"] = (a0) =>
  (_free = Module["_free"] = wasmExports["fa"])(a0));
